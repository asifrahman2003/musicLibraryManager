...
public class Album {
	...
	/**
     * Constructs a new Album with the specified details and an initial list of songs.
     *
     * @param title - The title of the album.
     * @param artist - The artist or band of the album.
     * @param genre - The genre of the album.
     * @param year - The release year of the album.
     * @param songs - The initial list of songs for the album.
     */
    public Album(String title, String artist, String genre, int year, List<Song> songs) {
        ...
        this.genre = genre;
        this.year = year;
        this.songs = new ArrayList<>(songs); // Copy the list to avoid external modification
    }
